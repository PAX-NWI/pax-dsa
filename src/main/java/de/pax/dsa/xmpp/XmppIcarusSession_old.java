...
import de.pax.dsa.connection.IIcarusSession_old;
 ...
 */
public class XmppIcarusSession_old implements IIcarusSession_old {
	private static final String SERVER = "jabber.de";

	private Logger logger = LoggerFactory.getLogger(XmppIcarusSession_old.class);
	...
	public void connect(String user, String password) {
		this.user = user;
		try {
			xmppManager = new XmppManager(SERVER, user, password, null);
